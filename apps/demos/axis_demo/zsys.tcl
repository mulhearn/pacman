...
\
  ...
  # Create instance: axis_demo_0, and set properties
  set block_name axis_demo
  set block_cell_name axis_demo_0
  if { [catch {set axis_demo_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_demo_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axil_to_regbus_0_P_REGBUS [get_bd_intf_pins axil_to_regbus_0/P_REGBUS] [get_bd_intf_pins axis_demo_0/S_REGBUS]
  ...
  connect_bd_intf_net -intf_net axis_demo_0_M_AXIS [get_bd_intf_pins axis_demo_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
