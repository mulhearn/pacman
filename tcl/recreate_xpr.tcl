...
#
# Generated by Vivado on Fri Apr 10 20:35:07 PDT 2020
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/srcs/ip/axi_stream_master/axi_stream_slave/axi_stream_slave_1.0"] [file normalize "$origin_dir/srcs/ip/axi_lite/axi_lite_1.0"] [file normalize "$origin_dir/srcs/ip/axi_lite_1.0"] [file normalize "$origin_dir/srcs/ip/axi-stream-master/axi-stream-master_1.0"] [file normalize "$origin_dir/ip/test-axi-stream/test-axi-stream_1.0"] [file normalize "$origin_dir/srcs/ip/test_ip/test_ip_1.0"] [file normalize "$origin_dir/srcs/ip"]" $obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "axi_lite_read_write" -objects $obj
set_property -name "top_arch" -value "arch_imp" -objects $obj
set_property -name "top_file" -value "srcs/fw/axi_lite_read_write.vhd" -objects $obj
...
set_property -name "top" -value "axi_loopback_tb" -objects $obj
...
# module references:
# axi_lite_read_write, axi_stream_to_larpix, axi_stream_to_larpix, larpix_to_axi_stream, larpix_to_axi_stream
  ...
  if { $bCheckModules == 1 } {
     set list_check_mods "\ 
  axi_lite_read_write\
  axi_stream_to_larpix\
  axi_stream_to_larpix\
  larpix_to_axi_stream\
  larpix_to_axi_stream\
  "
  ...
  # Create instance: axi_stream_to_larpix_0, and set properties
  set block_name axi_stream_to_larpix
  set block_cell_name axi_stream_to_larpix_0
  if { [catch {set axi_stream_to_larpix_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_stream_to_larpix_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.C_CHANNEL {0x01} \
   CONFIG.C_DATA_TYPE {0x44} \
 ] $axi_stream_to_larpix_0

  # Create instance: axi_stream_to_larpix_1, and set properties
  set block_name axi_stream_to_larpix
  set block_cell_name axi_stream_to_larpix_1
  if { [catch {set axi_stream_to_larpix_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_stream_to_larpix_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: larpix_to_axi_stream_0, and set properties
  set block_name larpix_to_axi_stream
  set block_cell_name larpix_to_axi_stream_0
  if { [catch {set larpix_to_axi_stream_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $larpix_to_axi_stream_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.C_M_AXIS_TDATA_CHANNEL {0x01} \
   CONFIG.C_M_AXIS_TDATA_TYPE {0x44} \
 ] $larpix_to_axi_stream_0

  # Create instance: larpix_to_axi_stream_1, and set properties
  set block_name larpix_to_axi_stream
  set block_cell_name larpix_to_axi_stream_1
  if { [catch {set larpix_to_axi_stream_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $larpix_to_axi_stream_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.C_M_AXIS_TDATA_CHANNEL {0x02} \
   CONFIG.C_M_AXIS_TDATA_TYPE {0x44} \
 ] $larpix_to_axi_stream_1
  ...
  connect_bd_intf_net -intf_net S02_AXIS_1 [get_bd_intf_pins axis_interconnect_0/S02_AXIS] [get_bd_intf_pins larpix_to_axi_stream_1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXIS_MASTER [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER] [get_bd_intf_pins axis_interconnect_0/S00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axi_stream_to_larpix_0/S_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axi_stream_to_larpix_1/S_AXIS] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net larpix_to_axi_stream_0_M_AXIS [get_bd_intf_pins axis_interconnect_0/S01_AXIS] [get_bd_intf_pins larpix_to_axi_stream_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_traffic_gen_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_lite_read_write_0/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net axi_stream_to_larpix_0_data_LArPix [get_bd_pins axi_stream_to_larpix_0/data_LArPix] [get_bd_pins larpix_to_axi_stream_0/data_LArPix]
  connect_bd_net -net axi_stream_to_larpix_0_data_update_LArPix [get_bd_pins axi_stream_to_larpix_0/data_update_LArPix] [get_bd_pins larpix_to_axi_stream_0/data_update_LArPix]
  connect_bd_net -net axi_stream_to_larpix_1_data_LArPix [get_bd_pins axi_stream_to_larpix_1/data_LArPix] [get_bd_pins larpix_to_axi_stream_1/data_LArPix]
  connect_bd_net -net axi_stream_to_larpix_1_data_update_LArPix [get_bd_pins axi_stream_to_larpix_1/data_update_LArPix] [get_bd_pins larpix_to_axi_stream_1/data_update_LArPix]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins larpix_to_axi_stream_0/timestamp] [get_bd_pins larpix_to_axi_stream_1/timestamp]
  connect_bd_net -net larpix_to_axi_stream_0_busy_LArPix [get_bd_pins axi_stream_to_larpix_0/busy_LArPix] [get_bd_pins larpix_to_axi_stream_0/busy_LArPix]
  connect_bd_net -net larpix_to_axi_stream_1_busy_LArPix [get_bd_pins axi_stream_to_larpix_1/busy_LArPix] [get_bd_pins larpix_to_axi_stream_1/busy_LArPix]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_lite_read_write_0/S_AXI_LITE_ACLK] [get_bd_pins axi_stream_to_larpix_0/S_AXIS_ACLK] [get_bd_pins axi_stream_to_larpix_1/S_AXIS_ACLK] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S01_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S02_AXIS_ACLK] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins larpix_to_axi_stream_0/M_AXIS_ACLK] [get_bd_pins larpix_to_axi_stream_1/M_AXIS_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_lite_read_write_0/S_AXI_LITE_ARESETN] [get_bd_pins axi_stream_to_larpix_0/S_AXIS_ARESETN] [get_bd_pins axi_stream_to_larpix_1/S_AXIS_ARESETN] [get_bd_pins axi_traffic_gen_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_interconnect_0/ARESETN] [get_bd_pins axis_interconnect_0/M00_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S01_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S02_AXIS_ARESETN] [get_bd_pins larpix_to_axi_stream_0/M_AXIS_ARESETN] [get_bd_pins larpix_to_axi_stream_1/M_AXIS_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_lite_read_write_0/S_AXI_LITE/reg0] SEG_axi_lite_read_write_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_traffic_gen_0/S_AXI/Reg0] SEG_axi_traffic_gen_0_Reg0
