...
#
# Generated by Vivado on Mon Jul 27 12:03:10 PDT 2020
...
proc create_hier_cell_axi_lite_reg_space { parentCell nameHier } {
  ...
  connect_bd_net -net clk_out_0_o [get_bd_ports CLK] [get_bd_pins clk_out_0/o]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports MOSI_EN_N] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_ports MOSI_EN_P] [get_bd_ports TILE_EN] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports TILE_SEL] [get_bd_pins xlslice_2/Dout]
