...
#
# Generated by Vivado on Tue May 05 11:54:01 PDT 2020
...
# module references:
# clk_out, larpix_clk_to_axi_stream, larpix_counter, larpix_mclk_sel, larpix_reset_gen, axi_lite_reg_space, uart_channel, uart_channel, uart_channel, uart_channel
...
proc create_hier_cell_data_rx { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net MCLK_1 [get_bd_pins clk_out_0/i] [get_bd_pins larpix_clk/MCLK] [get_bd_pins larpix_uart_array/MCLK]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins data_rx/ARESETN] [get_bd_pins data_tx/aresetn] [get_bd_pins dma/ARESETN] [get_bd_pins larpix_clk/RSTN] [get_bd_pins larpix_uart_array/ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_ports TILE_EN1] [get_bd_ports TILE_SEL1] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_ports TRIG] [get_bd_pins xlconstant_2/dout]
