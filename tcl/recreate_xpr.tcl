...
#
# Generated by Vivado on Mon Jul 27 19:04:19 PDT 2020
...
#    "/home/pmadigan/larpix-firmware/pacman/srcs/fw/obuf_diff_out.vhd"
...
set files [list \
 ...
 [file normalize "${origin_dir}/srcs/fw/obuf_diff_out.vhd"] \
...
set file "$origin_dir/srcs/fw/obuf_diff_out.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
if { [get_files obuf_diff_out.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/pmadigan/larpix-firmware/pacman/srcs/fw/obuf_diff_out.vhd
}
...
# Hierarchical cell: io_out
proc create_hier_cell_io_out { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_io_out() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: obuff_diff_out_0, and set properties
  set block_name obuff_diff_out
  set block_cell_name obuff_diff_out_0
  if { [catch {set obuff_diff_out_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuff_diff_out_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuff_diff_out_1, and set properties
  set block_name obuff_diff_out
  set block_cell_name obuff_diff_out_1
  if { [catch {set obuff_diff_out_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuff_diff_out_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuff_diff_out_2, and set properties
  set block_name obuff_diff_out
  set block_cell_name obuff_diff_out_2
  if { [catch {set obuff_diff_out_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuff_diff_out_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net Din1_1 [get_bd_pins I_TILE_EN] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net Din2_1 [get_bd_pins I_TILE_SEL] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net Din_1 [get_bd_pins I_TRIG] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net I_CLK_1 [get_bd_pins I_CLK] [get_bd_pins clk_ddr_out_0/i] [get_bd_pins clk_ddr_out_1/i]
  connect_bd_net -net I_RESETN_1 [get_bd_pins I_RESETN] [get_bd_pins O_RESETN] [get_bd_pins obuff_diff_out_0/i]
  connect_bd_net -net clk_ddr_out_0_o [get_bd_pins O_CLK] [get_bd_pins clk_ddr_out_0/o]
  connect_bd_net -net clk_ddr_out_0_o_n [get_bd_pins O_CLK_N] [get_bd_pins obuff_diff_out_1/o_n]
  connect_bd_net -net clk_ddr_out_0_o_p [get_bd_pins O_CLK_P] [get_bd_pins obuff_diff_out_1/o_p]
  connect_bd_net -net clk_ddr_out_1_o [get_bd_pins clk_ddr_out_1/o] [get_bd_pins obuff_diff_out_1/i]
  connect_bd_net -net obuff_diff_out_0_o_n [get_bd_pins O_RESETN_N] [get_bd_pins obuff_diff_out_0/o_n]
  connect_bd_net -net obuff_diff_out_0_o_p [get_bd_pins O_RESETN_P] [get_bd_pins obuff_diff_out_0/o_p]
  connect_bd_net -net obuff_diff_out_2_o_n [get_bd_pins O_TRIG_N] [get_bd_pins obuff_diff_out_2/o_n]
  connect_bd_net -net obuff_diff_out_2_o_p [get_bd_pins O_TRIG_P] [get_bd_pins obuff_diff_out_2/o_p]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins O_MOSI_EN_N] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins O_TRIG] [get_bd_pins obuff_diff_out_2/i] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins O_MOSI_EN_P] [get_bd_pins O_TILE_EN] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins O_TILE_SEL] [get_bd_pins xlslice_2/Dout]
...
proc create_hier_cell_axi_lite_reg_space { parentCell nameHier } {
  ...
  # Create instance: io_out
  create_hier_cell_io_out [current_bd_instance .] io_out
  ...
  # Create port connections
  connect_bd_net -net MCLK_1 [get_bd_pins io_out/I_CLK] [get_bd_pins larpix_clk/MCLK] [get_bd_pins larpix_trig/MCLK] [get_bd_pins larpix_uart_array/MCLK]
  ...
  connect_bd_net -net axi_lite_reg_space_tile_en [get_bd_pins axi_lite_reg_space/tile_en] [get_bd_pins io_out/I_TILE_EN]
  connect_bd_net -net axi_lite_reg_space_tile_sel [get_bd_pins axi_lite_reg_space/tile_sel] [get_bd_pins io_out/I_TILE_SEL]
  connect_bd_net -net io_out_MOSI_EN_N [get_bd_ports MOSI_EN_N] [get_bd_pins io_out/O_MOSI_EN_N]
  connect_bd_net -net io_out_O_CLK [get_bd_ports CLK] [get_bd_pins io_out/O_CLK]
  connect_bd_net -net io_out_O_CLK_N [get_bd_ports CLK_N] [get_bd_pins io_out/O_CLK_N]
  connect_bd_net -net io_out_O_CLK_P [get_bd_ports CLK_P] [get_bd_pins io_out/O_CLK_P]
  connect_bd_net -net io_out_O_MOSI_EN_P [get_bd_ports MOSI_EN_P] [get_bd_pins io_out/O_MOSI_EN_P]
  connect_bd_net -net io_out_O_RESETN [get_bd_ports RESETN] [get_bd_pins io_out/O_RESETN]
  connect_bd_net -net io_out_O_RESETN_N [get_bd_ports RESETN_N] [get_bd_pins io_out/O_RESETN_N]
  connect_bd_net -net io_out_O_RESETN_P [get_bd_ports RESETN_P] [get_bd_pins io_out/O_RESETN_P]
  connect_bd_net -net io_out_O_TRIG [get_bd_ports TRIG] [get_bd_pins io_out/O_TRIG]
  connect_bd_net -net io_out_O_TRIG_N [get_bd_ports TRIG_N] [get_bd_pins io_out/O_TRIG_N]
  connect_bd_net -net io_out_O_TRIG_P [get_bd_ports TRIG_P] [get_bd_pins io_out/O_TRIG_P]
  connect_bd_net -net io_out_TILE_SEL [get_bd_ports TILE_SEL] [get_bd_pins io_out/O_TILE_SEL]
  connect_bd_net -net larpix_clk_RST_SYNC_N [get_bd_pins io_out/I_RESETN] [get_bd_pins larpix_clk/RST_SYNC_N]
  connect_bd_net -net larpix_trig_TRIG_MASKED [get_bd_pins io_out/I_TRIG] [get_bd_pins larpix_trig/TRIG_MASKED]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_ports TILE_EN] [get_bd_pins io_out/O_TILE_EN]
