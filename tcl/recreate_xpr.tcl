...
#
# Generated by Vivado on Tue Oct 06 13:14:04 PDT 2020
...
set obj [get_filesets sim_1]
set_property -name "top" -value "larpix_reset_gen_tb" -objects $obj
...
# module references:
# axi_lite_reg_space, clk_ddr_out, clk_ddr_out, obuft_out, obuft_out, obuft_out, obuft_out, obuft_out, obuft_out, obuft_out, obuftds_out, obuftds_out, obuftds_out, larpix_clk_to_axi_stream, larpix_counter, larpix_mclk_sel, larpix_reset_gen, larpix_periodic_trig_gen, larpix_trig_gen, larpix_trig_to_axi_stream, axi_lite_reg_space, axi_lite_reg_space, uart_channel, uart_channel, uart_channel, uart_channel
...
proc create_hier_cell_larpix_clk { parentCell nameHier } {
  ...
  if { [catch {set larpix_mclk_sel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.C_ACLK_PERIOD {10.0} \
   CONFIG.C_AUX_CLK_PERIOD {50.0} \
   CONFIG.C_MCLK_PERIOD {100.0} \
 ] $larpix_mclk_sel_0
...
proc create_hier_cell_io { parentCell nameHier } {
  ...
  create_bd_pin -dir I I_MOSI1
  create_bd_pin -dir I I_MOSI2
  create_bd_pin -dir I I_MOSI3
  create_bd_pin -dir I I_MOSI4
  create_bd_pin -dir I I_RESETN
  create_bd_pin -dir I -from 7 -to 0 I_TILE_EN
  create_bd_pin -dir I -from 7 -to 0 I_TILE_SEL
  create_bd_pin -dir I -from 7 -to 0 I_TRIG
  create_bd_pin -dir O O_CLK
  create_bd_pin -dir O O_CLK_N
  create_bd_pin -dir O O_CLK_P
  create_bd_pin -dir O O_MOSI1
  create_bd_pin -dir O O_MOSI2
  create_bd_pin -dir O O_MOSI3
  create_bd_pin -dir O O_MOSI4
  create_bd_pin -dir O -from 0 -to 0 O_MOSI_EN_N
  create_bd_pin -dir O -from 0 -to 0 O_MOSI_EN_P
  create_bd_pin -dir O O_RESETN
  create_bd_pin -dir O O_RESETN_N
  create_bd_pin -dir O O_RESETN_P
  create_bd_pin -dir O -from 0 -to 0 O_TILE_EN
  create_bd_pin -dir O -from 0 -to 0 O_TILE_SEL
  create_bd_pin -dir O -from 0 -to 0 O_TRIG
  create_bd_pin -dir O -from 0 -to 0 O_TRIG_N
  create_bd_pin -dir O -from 0 -to 0 O_TRIG_P

  # Create instance: TILE_EN_0_SLICE, and set properties
  set TILE_EN_0_SLICE [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TILE_EN_0_SLICE ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: TILE_SEL_0_SLICE, and set properties
  set TILE_SEL_0_SLICE [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TILE_SEL_0_SLICE ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: TRIG_0_SLICE, and set properties
  set TRIG_0_SLICE [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 TRIG_0_SLICE ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: obuft_out_1, and set properties
  set block_name obuft_out
  set block_cell_name obuft_out_1
  if { [catch {set obuft_out_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuft_out_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuft_out_2, and set properties
  set block_name obuft_out
  set block_cell_name obuft_out_2
  if { [catch {set obuft_out_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuft_out_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuft_out_3, and set properties
  set block_name obuft_out
  set block_cell_name obuft_out_3
  if { [catch {set obuft_out_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuft_out_3 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuft_out_4, and set properties
  set block_name obuft_out
  set block_cell_name obuft_out_4
  if { [catch {set obuft_out_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuft_out_4 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: obuft_out_5, and set properties
  set block_name obuft_out
  set block_cell_name obuft_out_5
  if { [catch {set obuft_out_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuft_out_5 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: obuftds_out_1, and set properties
  set block_name obuftds_out
  set block_cell_name obuftds_out_1
  if { [catch {set obuftds_out_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $obuftds_out_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net Din1_1 [get_bd_pins I_TILE_EN] [get_bd_pins TILE_EN_0_SLICE/Din]
  connect_bd_net -net Din2_1 [get_bd_pins I_TILE_SEL] [get_bd_pins TILE_SEL_0_SLICE/Din]
  connect_bd_net -net Din_1 [get_bd_pins I_TRIG] [get_bd_pins TRIG_0_SLICE/Din]
  connect_bd_net -net I_CLK_1 [get_bd_pins I_CLK] [get_bd_pins clk_ddr_out_0/i] [get_bd_pins clk_ddr_out_1/i]
  connect_bd_net -net I_MOSI1_1 [get_bd_pins I_MOSI1] [get_bd_pins obuft_out_1/i]
  connect_bd_net -net I_MOSI2_1 [get_bd_pins I_MOSI2] [get_bd_pins obuft_out_2/i]
  connect_bd_net -net I_MOSI3_1 [get_bd_pins I_MOSI3] [get_bd_pins obuft_out_3/i]
  connect_bd_net -net I_MOSI4_1 [get_bd_pins I_MOSI4] [get_bd_pins obuft_out_4/i]
  connect_bd_net -net I_RESETN_1 [get_bd_pins I_RESETN] [get_bd_pins obuft_out_5/i] [get_bd_pins obuftds_out_1/i]
  connect_bd_net -net TRIG_0_SLICE_Dout [get_bd_pins TRIG_0_SLICE/Dout] [get_bd_pins obuft_out_6/i] [get_bd_pins obuftds_out_2/i]
  ...
  connect_bd_net -net obuft_out_1_o [get_bd_pins O_MOSI1] [get_bd_pins obuft_out_1/o]
  connect_bd_net -net obuft_out_2_o [get_bd_pins O_MOSI2] [get_bd_pins obuft_out_2/o]
  connect_bd_net -net obuft_out_3_o [get_bd_pins O_MOSI3] [get_bd_pins obuft_out_3/o]
  connect_bd_net -net obuft_out_4_o [get_bd_pins O_MOSI4] [get_bd_pins obuft_out_4/o]
  connect_bd_net -net obuft_out_5_o [get_bd_pins O_RESETN] [get_bd_pins obuft_out_5/o]
  ...
  connect_bd_net -net obuftds_out_1_o_n [get_bd_pins O_RESETN_N] [get_bd_pins obuftds_out_1/o_n]
  connect_bd_net -net obuftds_out_1_o_p [get_bd_pins O_RESETN_P] [get_bd_pins obuftds_out_1/o_p]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins O_MOSI_EN_N] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins O_MOSI_EN_P] [get_bd_pins O_TILE_EN] [get_bd_pins TILE_EN_0_SLICE/Dout] [get_bd_pins obuft_out_0/en] [get_bd_pins obuft_out_1/en] [get_bd_pins obuft_out_2/en] [get_bd_pins obuft_out_3/en] [get_bd_pins obuft_out_4/en] [get_bd_pins obuft_out_5/en] [get_bd_pins obuft_out_6/en] [get_bd_pins obuftds_out_0/en] [get_bd_pins obuftds_out_1/en] [get_bd_pins obuftds_out_2/en] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins O_TILE_SEL] [get_bd_pins TILE_SEL_0_SLICE/Dout]
...
proc create_hier_cell_axi_lite_reg_space { parentCell nameHier } {
  ...
  set MOSI_EN_N [ create_bd_port -dir O -from 0 -to 0 MOSI_EN_N ]
  set MOSI_EN_P [ create_bd_port -dir O -from 0 -to 0 MOSI_EN_P ]
  set RESETN [ create_bd_port -dir O -type rst RESETN ]
  set RESETN_N [ create_bd_port -dir O RESETN_N ]
  set RESETN_P [ create_bd_port -dir O RESETN_P ]
  set TILE_EN [ create_bd_port -dir O -from 0 -to 0 TILE_EN ]
  set TILE_SEL [ create_bd_port -dir O -from 0 -to 0 TILE_SEL ]
  set TRIG [ create_bd_port -dir O -from 0 -to 0 TRIG ]
  set TRIG1_IN [ create_bd_port -dir I TRIG1_IN ]
  set TRIG_N [ create_bd_port -dir O -from 0 -to 0 TRIG_N ]
  set TRIG_P [ create_bd_port -dir O -from 0 -to 0 TRIG_P ]
  ...
  connect_bd_net -net I_MOSI2_1 [get_bd_pins io/I_MOSI1] [get_bd_pins larpix_uart_array/UART_TX_1]
  connect_bd_net -net MCLK_1 [get_bd_pins io/I_CLK] [get_bd_pins larpix_clk/MCLK] [get_bd_pins larpix_trig/MCLK] [get_bd_pins larpix_uart_array/MCLK]
  ...
  connect_bd_net -net axi_lite_reg_space_tile_en [get_bd_pins axi_lite_reg_space/tile_en] [get_bd_pins io/I_TILE_EN]
  connect_bd_net -net axi_lite_reg_space_tile_sel [get_bd_pins axi_lite_reg_space/tile_sel] [get_bd_pins io/I_TILE_SEL]
  connect_bd_net -net io_O_MOSI1 [get_bd_ports MOSI1] [get_bd_pins io/O_MOSI1]
  connect_bd_net -net io_O_MOSI2 [get_bd_ports MOSI2] [get_bd_pins io/O_MOSI2]
  connect_bd_net -net io_O_MOSI3 [get_bd_ports MOSI3] [get_bd_pins io/O_MOSI3]
  connect_bd_net -net io_O_MOSI4 [get_bd_ports MOSI4] [get_bd_pins io/O_MOSI4]
  connect_bd_net -net io_out_MOSI_EN_N [get_bd_ports MOSI_EN_N] [get_bd_pins io/O_MOSI_EN_N]
  connect_bd_net -net io_out_O_CLK [get_bd_ports CLK] [get_bd_pins io/O_CLK]
  connect_bd_net -net io_out_O_CLK_N [get_bd_ports CLK_N] [get_bd_pins io/O_CLK_N]
  connect_bd_net -net io_out_O_CLK_P [get_bd_ports CLK_P] [get_bd_pins io/O_CLK_P]
  connect_bd_net -net io_out_O_MOSI_EN_P [get_bd_ports MOSI_EN_P] [get_bd_pins io/O_MOSI_EN_P]
  connect_bd_net -net io_out_O_RESETN [get_bd_ports RESETN] [get_bd_pins io/O_RESETN]
  connect_bd_net -net io_out_O_RESETN_N [get_bd_ports RESETN_N] [get_bd_pins io/O_RESETN_N]
  connect_bd_net -net io_out_O_RESETN_P [get_bd_ports RESETN_P] [get_bd_pins io/O_RESETN_P]
  connect_bd_net -net io_out_O_TRIG [get_bd_ports TRIG] [get_bd_pins io/O_TRIG]
  connect_bd_net -net io_out_O_TRIG_N [get_bd_ports TRIG_N] [get_bd_pins io/O_TRIG_N]
  connect_bd_net -net io_out_O_TRIG_P [get_bd_ports TRIG_P] [get_bd_pins io/O_TRIG_P]
  connect_bd_net -net io_out_TILE_SEL [get_bd_ports TILE_SEL] [get_bd_pins io/O_TILE_SEL]
  ...
  connect_bd_net -net larpix_uart_array_UART_TX_2 [get_bd_pins io/I_MOSI2] [get_bd_pins larpix_uart_array/UART_TX_2]
  connect_bd_net -net larpix_uart_array_UART_TX_3 [get_bd_pins io/I_MOSI3] [get_bd_pins larpix_uart_array/UART_TX_3]
  connect_bd_net -net larpix_uart_array_UART_TX_4 [get_bd_pins io/I_MOSI4] [get_bd_pins larpix_uart_array/UART_TX_4]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_ports TILE_EN] [get_bd_pins io/O_TILE_EN]
