...
# module references:
# axil_to_regbus, regbus_mux, registers_scratch, registers_scratch, registers_scratch, tx_unit, rx_unit
...
\
  ...
  # Create instance: registers_scratch_1, and set properties
  set block_name registers_scratch
  set block_cell_name registers_scratch_1
  if { [catch {set registers_scratch_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $registers_scratch_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: registers_scratch_2, and set properties
  set block_name registers_scratch
  set block_cell_name registers_scratch_2
  if { [catch {set registers_scratch_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $registers_scratch_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net regbus_mux_0_PA_REGBUS [get_bd_intf_pins regbus_mux_0/PA_REGBUS] [get_bd_intf_pins tx_unit_0/S_REGBUS]
  connect_bd_intf_net -intf_net regbus_mux_0_PB_REGBUS [get_bd_intf_pins regbus_mux_0/PB_REGBUS] [get_bd_intf_pins rx_unit_0/S_REGBUS]
  connect_bd_intf_net -intf_net regbus_mux_0_PC_REGBUS [get_bd_intf_pins regbus_mux_0/PC_REGBUS] [get_bd_intf_pins registers_scratch_0/S_REGBUS]
  connect_bd_intf_net -intf_net regbus_mux_0_PD_REGBUS [get_bd_intf_pins regbus_mux_0/PD_REGBUS] [get_bd_intf_pins registers_scratch_1/S_REGBUS]
  connect_bd_intf_net -intf_net regbus_mux_0_PE_REGBUS [get_bd_intf_pins regbus_mux_0/PE_REGBUS] [get_bd_intf_pins registers_scratch_2/S_REGBUS]
  ...
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins rx_unit_0/DMA_ITR_I]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins vio_0/clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axil_to_regbus_0/S_AXI_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins regbus_mux_0/ACLK] [get_bd_pins registers_scratch_0/ACLK] [get_bd_pins registers_scratch_1/ACLK] [get_bd_pins registers_scratch_2/ACLK] [get_bd_pins rx_unit_0/M_AXIS_ACLK] [get_bd_pins tx_unit_0/S_AXIS_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins tx_unit_0/UCLK_I]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn1 [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axil_to_regbus_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins regbus_mux_0/ARESETN] [get_bd_pins registers_scratch_0/ARESETN] [get_bd_pins registers_scratch_1/ARESETN] [get_bd_pins registers_scratch_2/ARESETN] [get_bd_pins rx_unit_0/M_AXIS_ARESETN] [get_bd_pins tx_unit_0/S_AXIS_ARESETN]
  connect_bd_net -net tx_unit_0_POSI_O [get_bd_pins tx_unit_0/POSI_O] [get_bd_pins rx_unit_0/PISO_I] [get_bd_pins rx_unit_0/LOOPBACK_I]
