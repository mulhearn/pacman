# mux_tile2.sh   use direct I2C access to set MUX switches for tile 2
#
# Sets registers 0x00, 0x01, 0x02, and 0x03 registers of the MAX14661
# so that:
#
# Front Panel ADC_TEST_OUTPUT <= TILE2_ANA_MON
# Front Panel DAC_TEST_INPUT  => TILE2_ADC_TEST
#
