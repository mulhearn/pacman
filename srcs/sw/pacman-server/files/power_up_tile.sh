...
# usage:
#   source power_up_tile.sh <tile number 1-8>
#
TILE=$1
...
VDDD_OFFSET=$(( (${TILE} - 1) * 2 + 1 ))
VDDA_OFFSET=$(( (${TILE} - 1) * 2 ))
VDDD_DAC_WRITE_ADDR=$(( 0x00024130 + $VDDD_OFFSET ))
VDDA_DAC_WRITE_ADDR=$(( 0x00024130 + $VDDA_OFFSET ))
