...
#define I2C_VREG_OFFSET_MON_VDDA   0x030  // ADC for VDDA voltage (one register per tile) // NOT YET IMPLEMENTED
#define I2C_VREG_OFFSET_MON_VDDD   0x040  // ADC for VDDD voltage (one register per tile) // NOT YET IMPLEMENTED
#define I2C_VREG_OFFSET_MON_IDDA   0x050  // ADC for VDDA current (one register per tile) // NOT YET IMPLEMENTED
#define I2C_VREG_OFFSET_MON_IDDD   0x060  // ADC for VDDA current (one register per tile) // NOT YET IMPLEMENTED
...
#define I2C_VREG_OFFSET_I2C_VER    0x220  // PACMAN I2C Version (Read Only) 
